...
const getSwapPanelPaddingValues = (
  ...
  outerPadding: DynamicSwapPanelPaddingValues;
  innerPadding: DynamicSwapPanelPaddingValues;
} => {
...
export function _CurrencyInputPanel(
  props: CurrentInputPanelProps
): JSX.Element {
  const {
    currencyAmount,
    currencyBalance,
  ...
  const { convertFiatAmountFormatted, formatCurrencyAmount } =
  ...
  const showInsufficientBalanceWarning =
    insufficientBalanceWarning && !isOutput;
  ...
  const { paddingBottom: innerPaddingBottom, paddingTop: innerPaddingTop } =
    innerPadding;
        ...
        {currencyInfo && (
          ...
          >
            <AmountInput
              ...
              testID={
                isOutput
                  ? ElementName.AmountInputOut
                  : ElementName.AmountInputIn
              }
              value={value}
          ...
          >
            ...
            {onSetMax && (
              <MaxAmountButton
                ...
                currencyField={
                  isOutput ? CurrencyField.OUTPUT : CurrencyField.INPUT
                }
