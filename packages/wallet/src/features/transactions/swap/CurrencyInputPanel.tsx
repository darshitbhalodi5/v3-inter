...
export const CurrencyInputPanel = memo(
  forwardRef<TextInput, CurrentInputPanelProps>(function _CurrencyInputPanel(
    ...
    const showInsufficientBalanceWarning =
      ...
      !!currencyBalance &&
      !!currencyAmount &&
      currencyBalance.lessThan(currencyAmount);
    ...
    const inputColor = showInsufficientBalanceWarning
      ? "$statusCritical"
      : emptyColor;
    ...
    return (
      <TouchableArea
        hapticFeedback
        onPress={currencyInfo ? onPressIn : onShowTokenSelector}
      >
        <Flex
          {...rest}
          overflow="hidden"
