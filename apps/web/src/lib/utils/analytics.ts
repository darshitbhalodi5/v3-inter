import { Currency, CurrencyAmount, Percent, Price, Token } from "darshitswap-sdk-core";
...
export const getPriceUpdateBasisPoints = (
  ...
  const changePercentage = new Percent(
    changeFraction.numerator,
    changeFraction.denominator,
  );
...
export function formatCommonPropertiesForTrade(
  ...
  return {
    ...
    ura_quote_block_number: isClassicTrade(trade)
      ? trade.blockNumber
      : undefined,
    ...
    minimum_output_after_slippage: trade
