import { ChainId, Currency, Token } from "darshitswap-sdk-core";
 ...
 * Returns undefined if tokenAddress is invalid or token does not exist.
 */
function useTokenFromMapOrNetwork(
  tokens: TokenMap,
...
export function useTokenListToken(
  tokenAddress?: string | null,
): Token | undefined {
  const { chainId } = useWeb3React();
