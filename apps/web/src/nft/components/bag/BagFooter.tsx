...
import { ChainId, Currency, CurrencyAmount, Token } from "darshitswap-sdk-core";
          ...
          >
            <PriceImpactRow>
              ...
              <ThemedText.BodySmall
                style={{ color: priceImpact.priceImpactSeverity.color }}
                lineHeight="20px"
              >
                  ...
                  <CurrencyInput
                    onClick={() => {
                      if (!bagIsLocked) {
                        ...
                        sendAnalyticsEvent(
                          NFTEventName.NFT_BUY_TOKEN_SELECTOR_CLICKED,
                        );
                      }
                    }}
                  >
