...
import { Currency, Percent } from "darshitswap-sdk-core";
...
const percent = (strings: TemplateStringsArray) =>
  new Percent(parseInt(strings[0]), 100);
...
it("renders when no routes are provided", () => {
  const { asFragment } = render(
    <RoutingDiagram currencyIn={DAI} currencyOut={USDC_MAINNET} routes={[]} />,
  );
