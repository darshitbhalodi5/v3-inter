...
import { Position } from "darshitswap-v3-sdk";
...
export const PositionPreview = ({
  ...
  const { formatCurrencyAmount, formatDelta, formatPrice, formatTickPrice } =
    useFormatter();
          ...
          <LightCard width="48%" padding="8px">
            <AutoColumn gap="4px" justify="center">
              ...
              <ThemedText.DeprecatedMain textAlign="center" fontSize="12px">
                <Trans>
                  {{ sym: quoteCurrency.symbol }} per{" "}
                  {{ symB: baseCurrency.symbol }}
                </Trans>
              </ThemedText.DeprecatedMain>
              ...
              >
                <Trans>
                  ...
                  {{ sym: baseCurrency?.symbol }} at this price
                </Trans>
              </ThemedText.DeprecatedSmall>
            </AutoColumn>
          </LightCard>
          ...
          <LightCard width="48%" padding="8px">
            <AutoColumn gap="4px" justify="center">
              ...
              >
                <Trans>
                  Your position will be 100% composed of{" "}
                  {{ sym: quoteCurrency?.symbol }} at this price
                </Trans>
              </ThemedText.DeprecatedSmall>
            </AutoColumn>
          </LightCard>
