...
export function TopTokensTable() {
  ...
  const { tokens, tokenSortRank, loadingTokens, sparklines, error } =
...
export const HEADER_DESCRIPTIONS: Record<
  TokenSortMethod,
  ReactNode | undefined
> = {
  ...
  [TokenSortMethod.FULLY_DILUTED_VALUATION]: (
    <Trans>
      Fully diluted valuation (FDV) calculates the total market value assuming
