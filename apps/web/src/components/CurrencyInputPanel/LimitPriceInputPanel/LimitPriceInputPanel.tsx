import { Currency, CurrencyAmount, Price } from "darshitswap-sdk-core";
    ...
    <Container>
      <Row justify="space-between">
        <LimitPriceInputLabel
          ...
          openCurrencySearchModal={() =>
            setCurrencySelectModalField("inputCurrency")
          }
        />
      ...
      <Row marginTop="8px" justify="space-between">
        <Row gap="sm">
          <LimitCustomMarketPriceButton
            ...
            selected={Boolean(
              currentPriceAdjustment !== undefined &&
                !presets.includes(currentPriceAdjustment),
            )}
          ...
          {presets.map((adjustmentPercentage) => {
            const adjustedPrice =
              adjustedPrices?.[
                adjustmentPercentage as keyof typeof adjustedPrices
              ];
            return (
              <LimitPresetPriceButton
                ...
                onSelect={() =>
                  onSelectLimitPrice(adjustedPrice, adjustmentPercentage)
                }
              />
            );
          })}
      ...
      <CurrencySearchModal
        ...
        onCurrencySelect={(currency) => {
          ...
          onCurrencySelect(
            limitPriceInverted
              ? invertCurrencyField(currencySelectModalField)
              : currencySelectModalField,
            currency,
          );
        }}
