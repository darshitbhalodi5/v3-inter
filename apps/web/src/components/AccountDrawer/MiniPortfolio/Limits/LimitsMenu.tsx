...
function useCancelMultipleOrders(
...
export function LimitsMenu({
  ...
  const [selectedOrdersByHash, setSelectedOrdersByHash] = useState<
    Record<string, UniswapXOrderDetails>
  >({});
