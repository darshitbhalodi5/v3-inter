  ...
  return (
    <Row justify="space-between" align="center">
      <Column gap="xs">
        ...
        <ThemedText.HeadlineLarge lineHeight="44px">
          {header}
...
export function SendReviewModal({
  ...
  const { unitag: recipientUnitag } = useUnitagByNameWithoutFlag(
    recipientData?.unitag,
    Boolean(recipientData?.unitag),
  );

  const { formatConvertedFiatNumberOrString, formatCurrencyAmount } =
    useFormatter();
