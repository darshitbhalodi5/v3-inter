...
import { NonfungiblePositionManager, Pool, Position } from "darshitswap-v3-sdk";
  ...
  return (
    <LightCard padding="12px">
      <AutoColumn gap="sm" justify="center">
        ...
        <ExtentsText>
          <Trans>
            {{ sym: currencyQuote?.symbol }} per{" "}
            {{ base: currencyBase?.symbol }}
          </Trans>
        </ExtentsText>
      </AutoColumn>
    </LightCard>
                  ...
                  <LightCard padding="12px" width="100%">
                    <AutoColumn gap="sm" justify="center">
                      ...
                      <ExtentsText>
                        {" "}
                        <Trans>
                          {{ symbol: currencyQuote?.symbol }} per{" "}
                          {{ base: currencyBase?.symbol }}
                        </Trans>
                      </ExtentsText>
                      ...
                      {inRange && (
                        <ThemedText.DeprecatedSmall color={theme.neutral3}>
                          <Trans>
                            ...
                            {{ symbol: currencyBase?.symbol }} at this price.
                          </Trans>
                    ...
                    <AutoColumn gap="sm" justify="center">
                      ...
                      {inRange && (
                        <ThemedText.DeprecatedSmall color={theme.neutral3}>
                          <Trans>
                            Your position will be 100%{" "}
                            {{ symbol: currencyQuote?.symbol }} at this price.
                          </Trans>
                        </ThemedText.DeprecatedSmall>
                      )}
                    </AutoColumn>
