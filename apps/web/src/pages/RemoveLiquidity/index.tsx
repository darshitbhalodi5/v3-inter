...
function RemoveLiquidity() {
      ...
      <AutoColumn gap="md" style={{ marginTop: "20px" }}>
        ...
        >
          <Trans>
            ...
            {{ allowed: allowedSlippage.toSignificant(4) }}% your transaction
            will revert.
          </Trans>
        </ThemedText.DeprecatedItalic>
      </AutoColumn>
  ...
  const pendingText = (
    <Trans>
      Removing {{ amtA: parsedAmounts[Field.CURRENCY_A]?.toSignificant(6) }}{" "}
      {{ symA: currencyA?.symbol }} and
    ...
    <>
      <AppBody>
        <AddRemoveTabs
          creating={false}
          adding={false}
          autoSlippage={DEFAULT_REMOVE_LIQUIDITY_SLIPPAGE_TOLERANCE}
        />
        <Wrapper>
