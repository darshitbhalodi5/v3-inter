...
import { Currency, CurrencyAmount, Percent } from "darshitswap-sdk-core";
...
export default function AddLiquidity() {
          ...
          <>
            ...
            >
              <Trans>
                ...
                {{ allowed: allowedSlippage.toSignificant(4) }}% your
  ...
  const pendingText = (
    <Trans>
      ...
      {{ symA: currencies[Field.CURRENCY_A]?.symbol }} and{" "}
                        ...
                        >
                          {approvalA === ApprovalState.PENDING ? (
                            <Dots>
                              <Trans>
                                Approving{" "}
                                {{ sym: currencies[Field.CURRENCY_A]?.symbol }}
                              </Trans>
                            </Dots>
                          ) : (
                            <Trans>
                        ...
                        >
                          {approvalB === ApprovalState.PENDING ? (
                            <Dots>
                              <Trans>
                                Approving{" "}
                                {{ sym: currencies[Field.CURRENCY_B]?.symbol }}
                              </Trans>
                            </Dots>
                          ) : (
                            <Trans>
