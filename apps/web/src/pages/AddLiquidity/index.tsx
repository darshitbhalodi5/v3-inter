...
import { FeeAmount, NonfungiblePositionManager } from "darshitswap-v3-sdk";
...
import {
  BlastRebasingAlert,
  BlastRebasingModal,
} from "pages/AddLiquidity/blastAlerts";
import {
  ButtonError,
  ButtonLight,
  ButtonPrimary,
...
const blastRebasingAlertAtom = atomWithStorage<boolean>(
  "shouldShowBlastRebasingAlert",
  true,
);
                ...
                >
                  {approvalA === ApprovalState.PENDING ? (
                    <Dots>
                      <Trans>
                        Approving{" "}
                        {{ amount: currencies[Field.CURRENCY_A]?.symbol }}
                      </Trans>
                    </Dots>
                  ) : (
                    <Trans>
                      Approve {{ amount: currencies[Field.CURRENCY_A]?.symbol }}
                    </Trans>
                  )}
                </ButtonPrimary>
              )}
                ...
                >
                  {approvalB === ApprovalState.PENDING ? (
                    <Dots>
                      <Trans>
                        Approving{" "}
                        {{ amount: currencies[Field.CURRENCY_B]?.symbol }}
                      </Trans>
                    </Dots>
                  ) : (
                    <Trans>
                      Approve {{ amount: currencies[Field.CURRENCY_B]?.symbol }}
                    </Trans>
                  )}
                </ButtonPrimary>
              )}
    ...
    <>
                  ...
                  <DynamicSection gap="md" disabled={!feeAmount || invalidPool}>
                    ...
                    {outOfRange && (
                      <YellowCard padding="8px 12px" $borderRadius="12px">
                        <RowBetween>
                          <AlertTriangle color="white" size="16px" />
                          ...
                          >
                            <Trans>
                              ...
                              trades until the market price moves into your
                              range.
                            </Trans>
                          </ThemedText.DeprecatedYellow>
                        </RowBetween>
                    ...
                    {invalidRange && (
                      <YellowCard padding="8px 12px" $borderRadius="12px">
                        <RowBetween>
                          ...
                          >
                            <Trans>
                              Invalid range selected. The min price must be
                              lower than the max price.
                            </Trans>
                          </ThemedText.DeprecatedYellow>
                        </RowBetween>
                      </YellowCard>
                    ...
                    {!noLiquidity ? (
                          ...
                          <AutoColumn gap="2px" style={{ marginTop: "0.5rem" }}>
                            ...
                            {baseCurrency && (
                              <ThemedText.DeprecatedBody
                                ...
                                fontSize={12}
                              >
                                {quoteCurrency?.symbol} <Trans>per</Trans>{" "}
                                {baseCurrency.symbol}
                              </ThemedText.DeprecatedBody>
                            )}
                          </AutoColumn>
                      ...
                      <AutoColumn gap="md">
                          ...
                          >
                            ...
                            >
                              <Trans>
                                ...
                                liquidity. To initialize, select a starting
                                price for the pool. Then, enter your liquidity
                                price range and deposit amount. Gas fees will be
                                higher than usual due to the initialization
                                transaction.
                              </Trans>
                            </ThemedText.DeprecatedBody>
                          </BlueCard>
                        ...
                        >
                          <ThemedText.DeprecatedMain>
                            <Trans>
                              Starting {{ sym: baseCurrency?.symbol }} Price:
                            </Trans>
                          </ThemedText.DeprecatedMain>
                          <ThemedText.DeprecatedMain>
                            {price ? (
      ...
      {showBlastRebasingModal && (
        <BlastRebasingModal
          ...
          onContinue={handleBlastModalContinue}
        />
      )}
    </>
  );
