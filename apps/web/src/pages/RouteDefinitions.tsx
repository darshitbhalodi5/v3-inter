...
const SwapTitle = t`Buy, sell & trade Ethereum and other top tokens on UdonSwap`;
...
export const routes: RouteDefinition[] = [
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Explore pools on UdonSwap`,
    getElement: () => (
  ...
  createRouteDefinition({
    path: "/send",
    getElement: () => <Swap />,
    getTitle: () => t`Send tokens on UdonSwap`,
  }),
  createRouteDefinition({
    path: "/limits",
  ...
  createRouteDefinition({
    path: "/pool",
    getElement: () => <Pool />,
    getTitle: () => t`Manage & provide pool liquidity on UdonSwap`,
  }),
  createRouteDefinition({
    path: "/pool/:tokenId",
